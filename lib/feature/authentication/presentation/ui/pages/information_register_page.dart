...
import 'package:lailaty/feature/authentication/presentation/ui/widgets/date_picker_widget.dart';
...
//!______________________ for user role______________________________
  ...
  Future<void> _getUserRole() async {
    ...
    setState(() {
      userRole = storedRole;
      if (storedRole != null) role = storedRole;
    });

    print("User Role: $storedRole");
  }
  ...
  // final String role = 'client'; //!must change this !!
                ...
                Timer(Duration(milliseconds: 1500), () {
                  setState(() {
                    ...
                    Timer(Duration(seconds: 5), () {
                      ...
                      //  context.go(AppKeys.searchOrderPage);
                    });
                  });
                });
              });
