...
abstract class AgreePageRepository {
  Future<Either<Failure, Unit>> addCar(CarViecleEntity addCarInfo,String paramter);
  Future<Either<Failure, Unit>> addMotor(MotorInfoBaseEntity addMotorInfo,String paramter);
