                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextWidget(
                              ...
                              fontSize: 18),
                          const SizedBox(height: 20),
                          CustomTextFormFieldPassword(controller: _passwordController, hintText: '12345678'),
                          const SizedBox(height: 40),
                          CustomTextWidget(
                              text: "       ادخل كلمة المرور مرة اخرى للتأكيد", fontSize: 18),
                          const SizedBox(height: 20),
                          CustomTextFormFieldPassword(controller: _passwordValidatorController, hintText: '12345678'),
                        ],
                      ),
                    ),
                  if (_clickCount == 2)
