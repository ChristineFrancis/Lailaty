class StringManager {
  ...
  static const String noticeContentFirstPart =
      " تهانينا على استكمل الخطوة الأولى لتصبح شريكاَ سائقاَ في تطبيق ليلتي لقد اعددنا تنويه مفصل ونصائح لمساعدتك للتسجيل في جميع فئات التطبيق المناسبة لسيارتك \n\nيحتوي التطبيق الفئات التالية:\n1-زفاف-مشاوير رجال الاعمال\n2-تعليم القيادة\n3-على مودك\n4-Ride-رحلات داخلية\n5-سفر\n\n يتميز تطبيقنا في فئات(السفر والرحلات RIDE ورحلات داخل المدن \nيتم التفاوض بين الافراد في تطبيقنا بشأن السعر مع بعضهم مع اقتراح للسعر العادل الذي يحدده التطبيق كحد أدنى (ولايمكن التلاعب به )وتكمن الفكرة الرئيسية في تطبيقنا في منح الافراد حرية الاختيار والتصدي للظلم.\n طفرة في عالم النقل التشاركي\n :ينفرد تطبيق ليلتي في الفئات التالية \n1-زفاف-مشاوير رجال الاعمال\n2-تعليم القيادة\n3-على مودك\n4-Ride-رحلات داخلية\n5-سفر\n\nوهي فئات جديدة من نوعها في عالم النقل التشاركي لإتاحة فرص عمل اكثر للشريك السائق\n نسبة التطبيق للفئات ( زفاف ومشاوير رجال أعمال -تعليم القياده - علي مودك) تتراوح بين 15-23% ويتم تقديرها حسب فئة وامكانيات السيارة ويتم إشعارك بنسبة التطبيق قبل التفاوض مع العميل \nيرجى الأخذ بعين الاعتبار ان عليك وضع سعرك المناسب للمشوار";
