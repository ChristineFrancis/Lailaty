...
class RideCarSelectOtherStations extends StatefulWidget {
  ...
  State<RideCarSelectOtherStations> createState() =>
      _RideCarSelectOtherStationsState();
}

class _RideCarSelectOtherStationsState
    extends State<RideCarSelectOtherStations> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
          top: MediaQuery.sizeOf(context).height * 0.3, bottom: 0),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        height: widget.sizeOfGreySection / 25,
                      ),
                      Row(
                      ...
                      Row(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ButtonLikeTextField(
                              text: '90 EGP- انقر لاقتراح السعر المناسب',
                              textSize: 15,
                              suffixWidget: Icon(Icons.edit_outlined),
                              //width: widthOfScreen*0.8,
                              onPressed: () async {
                                await suggestYourPriceBottomSheet(
                                    context, widget.priceController);
                              },
                            ),
                          ),
                        ],
                      ...
                      Row(
                        children: [
                          SvgPicture.asset(
                              ImageAssetManager.automaticAcceptanceIcon),
                          CustomTextWidget(
