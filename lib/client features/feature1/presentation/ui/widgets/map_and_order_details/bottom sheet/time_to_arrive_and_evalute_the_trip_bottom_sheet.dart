...
Future timeToArriveAndEvaluteTheTripBottomSheet(BuildContext context) {
                ...
                child: Container(
                 ...
                 padding:EdgeInsets.symmetric(horizontal: widthOfScreen/18),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Column(
                                    children: [
                                      CustomTextWidget(text: 'الوقت المقدر للوصول', fontSize: 17, color: Colors.black ),
                                      CustomTextWidget(text: '3:22دقيقة', fontSize: 17, color: Colors.black ),
                                    ],
                                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                       CustomTextWidget(text: 'كيف حال رحلتك؟', fontSize: 16, color: Colors.black ),
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                                    children: [
                                      SizedBox(
                                        ...
                                        child: CustomButton(textButton: 'جيدة', textSize: 14,color: ColorManager.grey,
                                        onTap: () { },),
                                      ),
                                      SizedBox(
                                        width: widthOfScreen/3,
                                        child: CustomButton(textButton: 'سيئة', textSize: 14,color: ColorManager.grey,
                                        onTap: () { },),
                                      ),
                                      
                                      ] ),
                                      CustomTextWidget(text: 'لن يعرف الكابتن بإجابتك على هذا السؤال', fontSize: 14, color: Colors.black, fontWeight:FontWeight.w400 , ),
